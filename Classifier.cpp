...
double VR_P[6] = {895791, 591046, 630186, 758484, 928395, 961682};
double VG_P[6] = {425218, 846944, 864880, 484856, 897501, 460849};
double VB_P[6] = {352430, 703509, 742837, 805604, 569245, 785462};
